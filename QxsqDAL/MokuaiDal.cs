...
namespace QxsqDAL
{
    public class MokuaiDal
    {
        ...
        public static void AddMokuai(MokuaiDto mokuaiDto)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(myconn, CommandType.StoredProcedure, "CreateMokuai", arParames);
}
        ...
        public static void UpdateMokuai(MokuaiDto mokuaiDto)
        {
            ...
            try
            {
                SqlHelper.ExecuteNonQuery(myconn, CommandType.StoredProcedure, "UpdateMokuai", arParames);
